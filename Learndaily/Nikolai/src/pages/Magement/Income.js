...
class Income extends PureComponent {
    ...
    const {
      form: { getFieldDecorator, getFieldValue },
        ...
        return(
            <PageHeaderWrapper
            title={<FormattedMessage id="app.magement.Income.title" />}
            content={<FormattedMessage id="app.magement.Income.description" />}
